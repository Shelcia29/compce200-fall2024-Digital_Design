...
set_property MARK_DEBUG true [get_nets {alien_x[4]}]
set_property MARK_DEBUG true [get_nets {alien_x[7]}]
set_property MARK_DEBUG true [get_nets {alien_x[6]}]
set_property MARK_DEBUG true [get_nets {alien_x[5]}]
set_property MARK_DEBUG true [get_nets {alien_x[3]}]
set_property MARK_DEBUG true [get_nets enable]
set_property MARK_DEBUG true [get_nets {alien_x[0]}]
set_property MARK_DEBUG true [get_nets {alien_x[2]}]
set_property MARK_DEBUG true [get_nets {alien_x[1]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {channel_OBUF[0]} {channel_OBUF[1]} {channel_OBUF[2]} {channel_OBUF[3]} {channel_OBUF[4]} {channel_OBUF[5]} {channel_OBUF[6]} {channel_OBUF[7]}]]
...
connect_debug_port u_ila_0/probe5 [get_nets [list lat_OBUF]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe7 [get_nets [list s_clk_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 1 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list s_rst_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe9]
set_property port_width 1 [get_debug_ports u_ila_0/probe9]
connect_debug_port u_ila_0/probe9 [get_nets [list s_sda_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe10]
set_property port_width 1 [get_debug_ports u_ila_0/probe10]
connect_debug_port u_ila_0/probe10 [get_nets [list sb_OBUF]]
